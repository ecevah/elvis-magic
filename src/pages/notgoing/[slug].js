    ...
    <>
      ...
      <div>
        <div className="h-[100vh] z-[2] mt-[1px] flex flex-col justify-between items-center w-[100vw]">
          <div
            id="header"
            className={`mx-auto py-[70px] flex flex-row justify-between items-center w-[1600px] bg-transparent max-[1600px]:px-5 max-[1600px]:w-[80%] max-[1441px]:w-[80%] max-[1440px]:mx-auto max-[1440px]:px-[30px]`}
          >
            <Image
            ...
            <div className="flex flex-row max-[1166px]:hidden">
              {auth ? (
                ...
                <div
                  onClick={() => setAuth(true)}
                  id="connectWallet"
                  className="flex justify-center cursor-pointer items-center px-[47px] py-[10px] border-solid rounded-lg border border-red-500 border-opacity-50 "
                >
                  <div
                    className={`${inter.className} font-bold text-[#FFFFFF] text-[14px] leading-[19px] cursor-default`}
                  >
          ...
          <Landing
            index={index}
            check={check}
            pageCheck={slug == "launchpad" ? false : pageCheck}
            id={router.query.slug}
            auth={auth}
            language={language}
          />
          <Footer index={index} pageCheck={pageCheck} language={language} />
        </div>
      </div>
    </>
  );
